      ...
      <div class="row">
         <div class="left col-lg-4 text-left" data-aos="fade-right" data-aos-duration="1300">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
               <button type="button" class="btn btn-secondary px-4 me-md-2">
                  <svg height="48px" width="144px" fill="#ffffff" x="0px" y="0px" viewBox="0 0 131 44" aria-hidden="true">
               ...
               <button type="button" class="btn btn-secondary px-4 ml-md-3">
                  <svg height="48px" width="144px" fill="#ffffff" x="0px" y="0px" viewBox="0 0 139 44" aria-hidden="true">
