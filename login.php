...
z
		...
		.bg-image {
		  background-image: url('https://ik.imagekit.io/sqtoptimizer/konar/tr:h-500/img/IMG_0356.jpg');
	...
	<div class="container-fluid">
	  <div class="row no-gutter">
	    ...
	    <div class="col-md-8 col-lg-6">
	    	<div class="sign-up-container">Not a user yet? <a class="text-primary" href="register.php">Sign Up</a></div>
	      <div class="login d-flex align-items-center py-5">
	        <div class="container">
	          <div class="row">
	            <div class="col-md-9 col-lg-8 mx-auto">
	              <h3 class="login-heading mb-4">Welcome to Konar!</h3>
	              <form>
