    ...
    <div class="row no-gutter">
      ...
      <div class="col-md-8 col-lg-6">
        <div class="login d-flex align-items-center py-5">
          <div class="container">
            <div class="row">
              <div class="col-md-9 col-lg-8 mx-auto" id="cc_content">
                ...
                <form id="ccform">
                  ...
                  <div class="form-label-group">
                    <input type="text" id="inputLocation" class="form-control" placeholder="Location" required name="location">
                    <label for="inputLocation">Full Address</label>
                  </div>

                  <div class="form-label-group">
                    <select name="i_am" id="input_i_am" class="form-control" required>
                      <option value="">Select Option</option>
                      <option value="individual">Individual</option>
                      <option value="company">Company</option>
                    </select>
                    <label for="input_i_am">I am</label>
                  </div>

                  <div class="form-label-group">
                    <input type="number" id="inputBikeCount" class="form-control" placeholder="How many bikes do you have?" required name="bike_count">
                    <label for="inputBikeCount">How many bikes do you have?</label>
                  </div>

                  <div class="form-label-group">
                    <textarea id="inputBikeDetails" class="form-control" placeholder="Bike Details" name="bike_details"></textarea>
                  </div>
  ...
  <script>
    $(function() {
      $("form#ccform").submit(function(event) {
        ...
        $.ajax({
          type: 'POST',
          url: 'logic/new-rider-request.php',
          data: str,
          cache: false,
